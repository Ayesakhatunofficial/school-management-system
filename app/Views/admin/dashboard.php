<?= $this->extend('themes/admin/main/layout') ?>
...
<div class="row">
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card btn-inverse-primary d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
                    <div class="ms-3 ml-md-0 ml-xl-3">
                        <h5 class="font-weight-bold">2.62 Subscribers</h5>
                        <p class="mt-2 card-text">You main list growing</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card  btn-inverse-warning d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
                    <div class="ms-3 ml-md-0 ml-xl-3">
                        <h5 class="font-weight-bold">3.4k Followers</h5>
                        <p class="mt-2 card-text">You main list growing</p>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card btn-inverse-info d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
                    <div class="ms-3 ml-md-0 ml-xl-3">
                        <h5 class="font-weight-bold">3k followers</h5>
                        <p class="mt-2 card-text">You main list growing</p>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card btn-inverse-success d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card btn-inverse-danger d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card btn-inverse-dark d-flex align-items-center">
            <div class="card-body py-5">
                <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <i class="mdi mdi-account icon-lg"></i>
